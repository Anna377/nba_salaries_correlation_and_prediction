...
# result = result.drop(columns=["PER","TS%","3PAr","FTr","ORB%","DRB%","TRB%","AST%","STL%","BLK%","TOV%","USG%"," ","OWS",
#                      "DWS","WS","WS/48","OBPM","DBPM","BPM","VORP"])
# filepath = Path('/Users/annamartirosyan/PycharmProjects/NBA_salaries/data/player_data/players2022/Per36_2022.csv')
