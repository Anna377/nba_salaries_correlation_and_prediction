...
wrangleSet <- function(year) {
  salName <- paste("/Users/annamartirosyan/PycharmProjects/NBA_salaries/data/salary_data/final_fa_salaries/",
                   year, ".csv", sep = "")
  # Location of NBA FA salaries
  statName <- paste("/Users/annamartirosyan/PycharmProjects/NBA_salaries/data/standardized_data/",
                    year,".csv", sep = "")
...
final <- rbind(data2015, data2016, data2017)

write.csv(final, "/Users/annamartirosyan/PycharmProjects/NBA_salaries/data/training_test_dataset.csv")
